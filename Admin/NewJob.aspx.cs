        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    "Salary=@Salary, JobType=@JobType, CompanyName=@CompanyName, " + concatQuery + @"Website=@Website, Email=@Email, Address=@Address, City=@City, CreateDate=@CreateDate where JobId=@id";
                    type = "Updated";
                    cmd = new SqlCommand(query, con);
                ...
                {
                    query = @"Insert into Jobs values(@Title,@NoOfPost,@Description,@Qualification,@Experience,@Specialization,@LastDateToApply,@Salary,@JobType,@CompanyName,@CompanyImage,@Website,@Email,@Address,@City,@CreateDate )";
                    type = " Saved";
