<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobDetails.aspx.cs" Inherits="EmploymentAgency.User.JobDetails" %>
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-xl-4 col-lg-4">
                                <div class="post-details3  mb-50">
                                    ...
                                    <ul>
                                        <li>Posted date : <span><%# Container.DataItem != null && DataBinder.Eval(Container.DataItem, "CreateDate") != DBNull.Value ? string.Format("{0:dd MMMM yyyy}", DataBinder.Eval(Container.DataItem, "CreateDate")) : "N/A" %></span></li>
                                        <li>Location : <span><%# Eval("City") %></span></li>
