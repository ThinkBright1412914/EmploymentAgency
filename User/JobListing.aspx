<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobListing.aspx.cs" Inherits="EmploymentAgency.User.JobListing" %>
                        ...
                        <div class="job-category-listing mb-50 pb-0">
                            ...
                            <div class="single-listing">
                                ...
                                <div class="select-job-items2">
                                    <asp:DropDownList ID="ddlCity" runat="server" name="select" CssClass="form-control w-100"
                                        DataSourceID="SqlDataSource1" AppendDataBoundItems="True" DataTextField="CityName"
                                        DataValueField="CityName" OnSelectedIndexChanged="ddlCity_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem Value="0">City</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EmploymentAgencyConnectionString %>"
                            ...
                            <div class="single-listing">
                                ...
                                <div class="mb-1">
                                    <asp:LinkButton ID="lbFilter" runat="server" CssClass="btn btn-sm w-100" OnClick="lbFilter_Click">Filter</asp:LinkButton>
                                </div>

                                <div class="mb-4">
                                    <asp:LinkButton ID="lbReset" runat="server" CssClass="btn btn-sm w-100" OnClick="lbReset_Click">Reset</asp:LinkButton>
                                </div>
                            </div>
                        </div>
